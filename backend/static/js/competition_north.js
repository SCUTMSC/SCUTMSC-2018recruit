	...
	$(document).ready(function() {
		...
		$("#register").submit(function(e) {
			...
			$.post("/api/add_layman_north", {
				...
				pro_major: register.pro_major.value,
				aimat: register.aimat.value,
				monologue: register.monologue.value,
				habbit: register.habbit.value,
				speciality: register.speciality.value,
				keypoint: register.keypoint.value,
				whyjoin: register.whyjoin.value,
				whychoose: register.whychoose.value,
